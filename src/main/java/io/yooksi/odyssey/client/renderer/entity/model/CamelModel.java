...
public class CamelModel
    ...
    /*
       ...
       ModelBox params, same as:
         ModelRenderer#addBox(texU, texV, x, y, z, dx, dy, dz, deltaX, deltaY, deltaZ, mirror, texWidth,
         texHeight)
     ...
     */
		...
		this.front_leg_right_top.setTextureOffset(66, 26).addBox(-1.875F, -1.3531F, -2.1361F, 5.0F, 9.0F,
				4.0F, 0.0F, false);
		...
		this.front_leg_left_foot.setTextureOffset(45, 82).addBox(-5.5F, -1.618F, -2.0542F, 4.0F, 2.0F, 4.0F,
				0.0F, false);
		...
		this.front_leg_left_top.setTextureOffset(45, 65).addBox(-2.0F, -1.2781F, -2.0361F, 5.0F, 9.0F, 4.0F,
				0.0F, false);
		...
		this.front_leg_left_bottom.setTextureOffset(15, 76).addBox(-1.525F, -0.1281F, -1.5361F, 4.0F, 10.0F,
				3.0F, 0.0F, false);
		...
		this.back_leg_right_top.setTextureOffset(27, 62).addBox(8.175F, -11.5781F, 14.9639F, 4.0F, 10.0F,
				6.0F, 0.0F, false);
		...
		this.back_leg_right_bottom.setTextureOffset(63, 69).addBox(-5.6F, 0.1767F, -1.4267F, 4.0F, 10.0F,
				3.0F, 0.0F, false);
		...
		this.back_leg_right_foot.setTextureOffset(45, 82).addBox(2.85F, -2.1801F, 5.9838F, 4.0F, 2.0F, 4.0F,
				0.0F, false);
		...
		this.back_leg_left_top.setTextureOffset(0, 63).addBox(-2.325F, -11.0281F, 15.2639F, 4.0F, 10.0F,
				6.0F, 0.0F, false);
		...
		this.back_leg_left_bottom.setTextureOffset(75, 40).addBox(-3.6F, -0.1983F, -1.4517F, 4.0F, 10.0F,
				3.0F, 0.0F, false);
		...
		this.back_leg_left_foot.setTextureOffset(45, 82).addBox(-7.15F, -1.6801F, 6.4338F, 4.0F, 2.0F, 4.0F,
				0.0F, false);
		...
		this.ear_left.setTextureOffset(0, 47).addBox(-2.8864F, -1.5338F, -0.0915F, 2.0F, 3.0F, 2.0F, 0.0F,
				false);
		...
		this.ear_right.setTextureOffset(0, 30).addBox(-2.1666F, -1.7753F, -0.1286F, 2.0F, 3.0F, 2.0F, 0.0F,
				false);
		...
		this.hump_back.setTextureOffset(35, 38).addBox(-5.5F, -3.3774F, -5.9113F, 11.0F, 5.0F, 9.0F, 0.0F,
				false);
		...
		this.hump_front.setTextureOffset(59, 59).addBox(-5.5F, 2.6561F, -4.7345F, 11.0F, 5.0F, 5.0F, 0.0F,
				false);
		...
		this.hump_butt.setTextureOffset(54, 24).addBox(-5.48F, -4.6033F, 0.6212F, 11.0F, 5.0F, 4.0F, 0.0F,
				false);
		...
		this.hump_back_middle.setTextureOffset(31, 52).addBox(-7.0F, -2.4501F, -3.6907F, 11.0F, 5.0F, 7.0F,
				0.0F, false);
	...
	@Override
	public void setLivingAnimations(CamelEntity camelEntity, float limbSwing, float limbSwingAmount,
									float partialTick) {
				...
				|| (!camelEntity.isSitting() && camelEntity.getSitTimer() < SIT_TIMER_START_VALUE))
		{
			...
			// Front Leg
			{
				this.front_leg_right.rotateAngleX =
						(float) (-Math.PI * 0.5f + (15 * DEGREES_TO_RADIANS)) * this.sitScalar;
				this.front_leg_left.rotateAngleX =
						(float) (-Math.PI * 0.5f + (15 * DEGREES_TO_RADIANS)) * this.sitScalar;
			}
			...
			// Front Leg Bottom
			{
				...
				// part of the leg.
				this.front_leg_right_bottom.rotateAngleX =
						(float) (Math.PI - (25 * DEGREES_TO_RADIANS)) * this.sitScalar;
				this.front_leg_right_bottom.rotateAngleZ = 3 * DEGREES_TO_RADIANS * this.sitScalar;
				this.front_leg_left_bottom.rotateAngleX =
						(float) (Math.PI - (25 * DEGREES_TO_RADIANS)) * this.sitScalar;
			...
			// Back Leg
			{
				this.back_leg_right.rotateAngleX =
						(float) (-Math.PI * 0.5f + (15 * DEGREES_TO_RADIANS)) * this.sitScalar;
				this.back_leg_left.rotateAngleX =
						(float) (-Math.PI * 0.5f + (15 * DEGREES_TO_RADIANS)) * this.sitScalar;
			}
			...
			// Back Leg Bottom
			{
				...
				// to avoid some Z-fighting, plus it looks better to be able to see that
				// part of the leg.
				this.back_leg_right_bottom.rotateAngleX =
						(float) (Math.PI - (25 * DEGREES_TO_RADIANS)) * this.sitScalar;
				this.back_leg_right_bottom.rotateAngleZ = 3 * DEGREES_TO_RADIANS * this.sitScalar;
				this.back_leg_left_bottom.rotateAngleX =
						(float) (Math.PI - (25 * DEGREES_TO_RADIANS)) * this.sitScalar;
	...
	@Override
	public void setRotationAngles(@Nonnull CamelEntity camelEntity, float limbSwing, float limbSwingAmount,
	...
	@Override
	public void render(@Nonnull MatrixStack matrixStack, @Nonnull IVertexBuilder buffer, int packedLight,
